...
public class SecurityConfig {
     ...
     * added before the {@link BasicAuthenticationFilter} to validate JWT tokens in incoming requests. This ensures that tokens are validated before accessing secured
     * resources.
     *
     * @param http the {@link HttpSecurity} object to configure
     * @throws Exception if an error occurs during configuration
     ...
     * users with the appropriate authorities or roles can access restricted resources.
     *
     * @param http the {@link HttpSecurity} object to configure
     * @throws Exception if an error occurs during configuration
     */
